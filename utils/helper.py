...
def scanrefer_get_unique_multiple_lookup():
    unique_multiple_lookup_file = '/content/drive/MyDrive/Chat-3D-v2-main/annotations/scanrefer_unique_multiple_lookup.json'
    if not os.path.exists(unique_multiple_lookup_file):
        ...
        raw2label = {}
        with open('/content/drive/MyDrive/Chat-Scene-dev/annotations/scannet/scannetv2-labels.combined.tsv', 'r') as f:
        ...
        scanrefer_data = json.load(open('/content/drive/MyDrive/Chat-Scene-dev/annotations/scanrefer/ScanRefer_filtered.json'))
