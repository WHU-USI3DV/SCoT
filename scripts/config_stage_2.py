# ========================= data ==========================
anno_root = "./SCoT_Dataset/annotations"  # annotation dir
pc_encoder = "uni3d"
segmentor = "mask3d"
version = ""
...
train_file_dict = {
    'scanrefer': [
        ...
        seg_img_feat_file,
        seg_train_attr_file,
        f"./SCoT_Dataset/SCoT_Training_Stage_2/GroundingData_CoT_Train.json"
    ],
    'scanrefer_location': [
        seg_feat_file,
        seg_img_feat_file,
    ...
    'scan2cap': [
        ...
        seg_img_feat_file,
        seg_train_attr_file,
        f"./SCoT_Dataset/SCoT_Training_Stage_2/ObjectData_CoT_Train"
    ],
    'scan2cap_location': [
        seg_feat_file,
        seg_img_feat_file,
    ...
    'sqa3d': [
        ...
        seg_img_feat_file,
        seg_train_attr_file,
        f"./SCoT_Dataset/SCoT_Training_Stage_2/SceneData_CoT_Train"
    ],
    'multi3dref': [
        seg_feat_file,
        seg_img_feat_file,
...
val_file_dict = {
    ...
    'scanrefer': [
        ...
        seg_img_feat_file,
        seg_val_attr_file,
        f"./SCoT_Dataset/SCoT_Val/ImplicitDetection_Val.json"
    ],
    'scanrefer_test': [
        seg_all_feat_file,
        seg_all_img_feat_file,
    ...
    'sqa3d': [
        ...
        seg_img_feat_file,
        seg_val_attr_file,
        f"./SCoT_Dataset/SCoT_Val/ObjectAnalysis_Val"
    ],
    'sqa3d_test': [
        seg_all_feat_file,
        seg_all_img_feat_file,
    ...
    'scannet_region_caption': [
        ...
        seg_img_feat_file,
        seg_train_attr_file,
        f"{anno_root}/scannet_region_caption_{segmentor}_val{version}.json",
    ],
}
...
optimizer = dict(
    ...
    weight_decay=0.02,
    scaler_enable=False,
    max_grad_norm=0.1,  # requires a positive float, use -1 to disable
